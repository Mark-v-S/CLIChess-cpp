...
//bool Rock(char** space, int row, int slot, /*char moverow, int moverowi, int moveslot, int i, int j, bool moved,*/ char piece, char* pos)
...
void playerMove2(char** space, char* charsp, char* charspe)
{
    ...
    do {
        ...
        switch (space[row] [slot])
        {
            ...
            break;
            case 'k':
            moved = Knight(space, row, rowis, slot, moverow, moverow, moveslot, moved, charsp[2], charsply);
            break;
            case 'b':
            moved = Bishop(space, row, rowis, slot, moverow, moverow, moveslot, i, j, moved, charsp[3], charsply);
            break;
            case 'Q':
            moved = Quin(space, row, rowis, slot, moverow, moverow, moveslot, i, j, moved, charsp[4], charsply);
            break;
            case 'K':
            moved = King(space, row, rowis, slot, moverow, moverow, moveslot, moved, charsp[5], charsply);
            break;
        }
    } while (moved == false);
}
